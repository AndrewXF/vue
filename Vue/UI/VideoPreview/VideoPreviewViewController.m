...
- (void)initButtons
{
    ...
    .heightIs(.5)
    .bottomSpaceToView(_tableView, 20);
...
- (void)initVideoThemes
{
    ...
    self.tableView.frame = CGRectMake(0, SCREEN_HEIGHT - 20, SCREEN_WIDTH, CELL_THEME_H);
